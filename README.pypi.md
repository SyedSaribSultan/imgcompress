...
![The app, dark theme](https://raw.githubusercontent.com/SyedSaribSultan/pocketsize/v2.7.0/docs/screenshot-dark.webp)
...
[tests/BENCHMARK.md](https://github.com/SyedSaribSultan/pocketsize/blob/v2.7.0/tests/BENCHMARK.md) holds a reproducible head-to-head
...
![Before / after comparison](https://raw.githubusercontent.com/SyedSaribSultan/pocketsize/v2.7.0/docs/screenshot-compare.jpg)
...
![Light theme](https://raw.githubusercontent.com/SyedSaribSultan/pocketsize/v2.7.0/docs/screenshot-light.webp)
</details>
...
[tests/VIDEO_BENCHMARK.md](https://github.com/SyedSaribSultan/pocketsize/blob/v2.7.0/tests/VIDEO_BENCHMARK.md) is the reproducible
...
anyway. See [docs/THIRD_PARTY_NOTICES.md](https://github.com/SyedSaribSultan/pocketsize/blob/v2.7.0/docs/THIRD_PARTY_NOTICES.md).
...
See [CONTRIBUTING.md](https://github.com/SyedSaribSultan/pocketsize/blob/v2.7.0/CONTRIBUTING.md). The one rule worth stating up front: any
